			...
			<tr>
				...
				<td>
					<table width="98%" border="0" cellspacing="0" cellpadding="4"
						...
						<c:forEach items="${listEtalents}" var="etalent">
							<tr align="center" class="trbg">
								<td>${etalent.taid}</td>
								<td><a href="detailsEtalent.aspx?etalent.taid=${etalent.taid}">${etalent.ejobs.jtitle}</a></td>
								<td>${etalent.tatitle}</td>
								<td>${etalent.taname}</td>
								<td>${etalent.taaddtime}</td>
								<td>
									<a href="deleteEtalent.aspx?etalent.taid=${etalent.taid }">删除</a>
								</td>
							</tr>
						</c:forEach>
					</table>
