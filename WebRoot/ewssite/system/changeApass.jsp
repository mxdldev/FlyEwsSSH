	...
	<body>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					<form action="editEauser.aspx" method="post" name="form1"
						...
						<table width="95%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td>
									<input type="text" name="eauser.aname" readonly="readonly"
										class="x-form-text" width="140px" size="20" id="aname" value="${eauser.aname}"
										onblur="checkfaaname()" />
							...
							<tr>
								...
								<td>
									<input type="text" name="eauser.atname" class="x-form-text" id="atname" value="${eauser.atname}"
										width="140px" size="20" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<select name="eauser.eagrouptype.agtid" style="width: 150px;">
										<c:forEach items="${listEagrouptype}" var="eagrouptype">
											<c:choose>
												<c:when test="${eauser.eagrouptype.agtid==eagrouptype.agtid}">
								        			<option value="${eagrouptype.agtid}" selected="selected">${eagrouptype.agtname}</option>
												</c:when>
												<c:otherwise>
							...
							<tr>
								...
								<td>
									<input type="hidden" name="eauser.aid" value="${eauser.aid}" />
									<input type="hidden" name="eauser.aaddtime" value="${eauser.aaddtime}" />
									<input type="hidden" name="eauser.aip" value="${eauser.aip}" />
